...
internal enum Asset {
  internal enum Assets {
    ...
    internal static let misoRamen = ImageAsset(name: "miso_ramen")
    internal static let shioRamen = ImageAsset(name: "shio_ramen")
    internal static let shoyuRamen = ImageAsset(name: "shoyu_ramen")
    internal static let tantanmen = ImageAsset(name: "tantanmen")
    internal static let tonkotsuRamen = ImageAsset(name: "tonkotsu_ramen")
  }
